...
(function($) {
    $.fn.asLightboxHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
        ...
        $videoObj.bind(eClick, function() {
            userActive =
                true
        }).hover(function() { userActive = true }, function() { userActive = false });
        ...
        }).hover(function() { $(this).css({ "background-position": "bottom left" }) }, function() { $(this).css({ "background-position": "top left" }) }).bind(eClick, function() { $videoObj.get(0).play() });
        $videoBtnPause.css({ display: "none", position: "absolute", top: 0, left: 0, width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", cursor: "pointer", "background-image": "url('" + skinFolder + "html5boxplayer_playpause.png" + "')", "background-position": "top right" }).hover(function() { $(this).css({ "background-position": "bottom right" }) },
            function() { $(this).css({ "background-position": "top right" }) }).bind(eClick, function() { $videoObj.get(0).pause() });
        ...
        if (!isIPhone && ($videoObj.get(0).requestFullscreen || $videoObj.get(0).webkitRequestFullScreen || $videoObj.get(0).mozRequestFullScreen || $videoObj.get(0).webkitEnterFullScreen || $videoObj.get(0).msRequestFullscreen)) {
            var switchScreen =
                function(fullscreen) {
                    if (fullscreen) { if ($videoObj.get(0).requestFullscreen) $videoObj.get(0).requestFullscreen();
                        else if ($videoObj.get(0).webkitRequestFullScreen) $videoObj.get(0).webkitRequestFullScreen();
                        else if ($videoObj.get(0).mozRequestFullScreen) $videoObj.get(0).mozRequestFullScreen();
                        else if ($videoObj.get(0).webkitEnterFullScreen) $videoObj.get(0).webkitEnterFullScreen(); if ($videoObj.get(0).msRequestFullscreen) $videoObj.get(0).msRequestFullscreen() } else if (document.cancelFullScreen) document.cancelFullScreen();
            ...
            document.addEventListener("mozfullscreenchange",
                function() { isFullscreen = document.mozFullScreen;
            ...
            $videoFullscreen.css({ display: "block", position: "relative", "float": "right", width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", margin: Math.floor((BAR_HEIGHT - BUTTON_SIZE) / 2), cursor: "pointer", "background-image": "url('" + skinFolder + "html5boxplayer_fullscreen.png" + "')", "background-position": "left top" }).hover(function() {
                ...
                $(this).css({ "background-position": backgroundPosX + " top" }) }).bind(eClick, function() { isFullscreen = !isFullscreen;
        ...
        if ($videoObj.get(0).volume === volume / 2 + 0.1) {
            ...
            var $videoVolumeBarActive = $(".html5boxVolumeBarActive",
                $videoControls);
            $videoVolume.css({ display: "block", position: "relative", "float": "right", width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", margin: Math.floor((BAR_HEIGHT - BUTTON_SIZE) / 2) }).hover(function() { clearTimeout(hideVolumeBarTimeoutId); var volume = $videoObj.get(0).volume;
...
(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.createMarkup = function() {
            if (inst.options.titlestyle == "inside") { inst.options.titlecss = inst.options.titleinsidecss;
                inst.options.descriptioncss = inst.options.descriptioninsidecss } else if (inst.options.titlestyle == "bottom") { inst.options.titlecss = inst.options.titlebottomcss;
            ...
            if (inst.options.titlestyle == "inside") {
                ...
                inst.$text.css({ "margin": "0 " + inst.options.bordersize + "px" }) } inst.$lightboxBox.append("<div id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><img src='" +
            ...
            inst.$prev.click(function() { if (inst.options.prevElem >= inst.options.curElem)
        ...
        inst.calcNextPrevElem = function() {
            ...
            if (curGroup != undefined && curGroup != null) {
                for (j = inst.options.curElem + 1; j < inst.elemArray.length; j++)
                    if (inst.elemArray[j][ELEM_GROUP] == curGroup) { inst.options.nextElem = j; break } if (inst.options.nextElem < 0)
        ...
        inst.showNavigation = function() {
            ...
            for (i = 0; i < inst.elemArray.length; i++)
                if (group == inst.elemArray[i][ELEM_GROUP])
                    if (inst.elemArray[i][ELEM_THUMBNAIL] && inst.elemArray[i][ELEM_THUMBNAIL].length > 0) { showNav = true; break } if (!showNav) return;
        ...
        inst.showTitle = function(w, t, description) { if (inst.options.titlestyle == "inside") inst.$elemData.css({ width: w + "px" }); var text = ""; if (inst.options.showtitle && t && t.length > 0) text += t; if (inst.options.showdescription && description && description.length > 0) text += '<p class="html5-description">' + description + "</p>";
            inst.$text.html(text) }, inst.showImage = function(elem, imgW, imgH) {
            var elemW, elemH;
        ...
        inst.showVideo = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                ...
                if (isHTML5) { var videoSrc = elem[ELEM_HREF]; if (inst.options.isFirefox || inst.options.isOpera || !videoSrc) videoSrc = elem[ELEM_HREF_WEBM] ? elem[ELEM_HREF_WEBM] : elem[ELEM_HREF_OGG];
                    inst.embedHTML5Video($("#html5lightbox-video"), videoSrc, inst.options.autoplay) } else {
        ...
        inst.prepareDailymotionHref = function(href) { if (href.match(/\:\/\/.*(dai\.ly)/i)) { var protocol = window.location.protocol == "https:" ? "https:" : "http:"; var id = href.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2];
        ...
        inst.showYoutubeVimeo = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                ...
                if (elem[ELEM_TYPE] == 3) { if (href.indexOf("?") < 0) href += "?wmode=transparent&rel=0";
                    else href += "&wmode=transparent&rel=0"; if (inst.options.videohidecontrols) href += "&controls=0&showinfo=0" } $("#html5lightbox-video").html("<iframe width='100%' height='100%' src='" + href + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                inst.$elem.show();
                inst.showData()
            })
        };
        ...
        inst.showDiv = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                inst.$loading.hide();
                inst.showTitle(sizeObj.w, elem[ELEM_TITLE], elem[ELEM_DESCRIPTION]);
                inst.$image.css({ width: sizeObj.w, height: sizeObj.h }).html("<div id='html5lightbox-div' style='display:block;width:100%;height:100%;" + (inst.options.isIOS ? "-webkit-overflow-scrolling:touch;overflow-y:scroll;" : "overflow:auto;") + "'></div>").show();
        ...
        inst.showWeb = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                inst.$loading.hide();
                inst.showTitle(sizeObj.w, elem[ELEM_TITLE], elem[ELEM_DESCRIPTION]);
                inst.$image.css({ width: sizeObj.w, height: sizeObj.h }).html("<div id='html5lightbox-web' style='display:block;width:100%;height:100%;" +
        ...
        inst.showData =
            function() { if (inst.$text.text().length > 0) inst.$elemData.show(); if (inst.$text.text().length > 0 && inst.options.titlestyle != "inside") inst.$lightboxBox.css({ height: String(inst.$lightboxBox.height() + inst.options.barheight) + "px" });
        ...
        inst.resizeLightbox = function(elemW, elemH, bAnimate, onFinish) {
            ...
            inst.$elemWrap.animate({ width: boxW },
                speed).animate({ height: boxH }, speed, function() { inst.$loading.show();
                inst.$watermark.show();
                inst.$close.show();
        ...
        inst.finish = function() { if ($("#html5-lightbox-video", inst.$lightbox).length) $("#html5-lightbox-video", inst.$lightbox).attr("src", "");
            inst.reset();
            inst.resetNavigation();
            inst.$lightbox.hide();
            inst.showObjects(); if (inst.options.oncloselightbox && window[inst.options.oncloselightbox] && typeof window[inst.options.oncloselightbox] == "function") window[inst.options.oncloselightbox](inst.currentElem) };
        ...
        inst.enableSwipe = function() { inst.$elem.touchSwipe({ preventWebBrowser: true, swipeLeft: function() { inst.gotoSlide(-1) }, swipeRight: function() { inst.gotoSlide(-2) } }) };
    ...
    $.fn.asHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton) {
        ...
        if ($videoObj.get(0).volume ===
            ...
            $videoVolumeButton.css({
                ...
                $(this).css({ "background-position": backgroundPosX + " top" }) }).bind(eClick,
                function() { var volume = $videoObj.get(0).volume; if (volume > 0) { volumeSaved = volume;
                        volume = 0 } else volume = volumeSaved; var backgroundPosY = $(this).css("background-position") ? $(this).css("background-position").split(" ")[1] : $(this).css("background-position-y");
                    $videoVolumeButton.css({ "background-position": (volume > 0 ? "left" : "right") + " " + backgroundPosY });
                    $videoObj.get(0).volume = volume;
...
(function($) {
    $.fn.amazingslider = function(options) {
        ...
        var AmazingSlider = function(container, options,
            textoptions, id) { this.container = container;
        ...
        AmazingSlider.prototype = {
                    ...
                    if (img.length > 0) {
                        ...
                        if ($("video", $(this)).length > 0) {
                            ...
                            if (videoType == TYPE_VIDEO_MP4)
                                if ($video.data("webm") &&
                                    $video.data("webm").length > 0) video.push({ href: $video.data("webm"), type: TYPE_VIDEO_WEBM })
                        }
            ...
            initVideoApi: function() {
                ...
                if (initYoutube) { var tag = document.createElement("script");
                    tag.src = ("https:" == document.location.protocol ? "https" : "http") + "://www.youtube.com/iframe_api"; var firstScriptTag = document.getElementsByTagName("script")[0];
            ...
            createSliderTimeout: function() {
                var instance = this;
                this.sliderTimeout = new ASliderTimer(this.options.slideinterval, function() { instance.slideRun(-1) }, this.options.showtimer ? function(percent) { instance.updateTimer(percent) } : null);
            ...
            createMarkup: function() {
                ...
                var instance = this;
                if (this.options.enabletouchswipe) $(".amazingslider-swipe-box-" + this.id, this.container).touchSwipe({ preventWebBrowser: false, swipeLeft: function() { instance.slideRun(-1) }, swipeRight: function() { instance.slideRun(-2) } });
            ...
            playYoutubeVideo: function(href, autoplay) {
                ...
                if (ASYouTubeIframeAPIReady && !ASPlatforms.isIE6() && !ASPlatforms.isIE7() && !ASPlatforms.isIOS() && !ASPlatforms.isAndroid()) {
                    ...
                    new YT.Player("amazingslider-video-" + this.id, { width: instance.options.width, height: instance.options.height, videoId: id, playerVars: params, events: { "onReady": function(event) { event.target.playVideo() }, "onStateChange": function(event) { if (event.data == YT.PlayerState.ENDED) { instance.videoPaused = false; if (!instance.isPaused) instance.slideRun(-1) } } } })
                } else {
                    var src =
                ...
                this.container.bind("amazingslider.switchtext", function(event, prev, cur) {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (instance.elemArray[cur][ELEM_BUTTON].length >
                            0) $button.html(instance.elemArray[cur][ELEM_BUTTON]).css({ "display": "block" });
            ...
            resizeSlider: function() {
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    var $carRightArrow = $(".amazingslider-car-right-arrow-" + this.id,
                        this.container);
                    if (this.options.navmultirows) { if (this.options.navdirection == "horizontal") { var n = Math.floor($nav.width() / (this.options.navwidth + this.options.navspacing)); if (n <= 0) n = 1;
                            m = Math.floor(($nav.width() - n * this.options.navwidth - (n - 1) * this.options.navspacing) / 2) - 2;
                            $navContainer.css({ width: "100%", "margin-left": m + "px" }) } } else if (this.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() || this.options.navdirection == "horizontal" && $bulletWrapper.width() > $navContainer.width()) {
                        if (this.options.navthumbnavigationstyle !=
                            "arrowinside") { $carLeftArrow.css({ display: "block" });
                            $carRightArrow.css({ display: "block" }) }
                        var l = 0;
                        if (this.options.navdirection == "vertical") { l = isNaN(parseInt($bulletWrapper.css("margin-top"))) ? 0 : parseInt($bulletWrapper.css("margin-top")); if (l <= $navContainer.height() - $bulletWrapper.height()) l = $navContainer.height() - $bulletWrapper.height(); if (l >= 0) l = 0;
                            $bulletWrapper.css({ "margin-top": l }) } else {
                            var m = 0;
                            if (this.options.navthumbnavigationstyle == "arrow") {
                                ...
                                if (this.options.navdirection == "horizontal")
                                    if (this.options.navmultirows) { var n = Math.floor($nav.width() / (this.options.navwidth + this.options.navspacing)); if (n <= 0) n = 1;
            ...
            createArrows: function() {
                ...
                $leftArrow.hover(function() { $(this).css({ "background-position": "left bottom" }) },
            ...
            createNav: function() {
                ...
                if (this.options.navdirection == "vertical") {
                    ...
                    if (this.options.navshowbuttons) { if (this.options.navshowarrow) { len += len > 0 ? this.options.navspacing : 0;
                            len += 2 * this.options.navheight + this.options.navspacing } if (this.options.navshowplaypause && !this.options.navshowplaypausestandalone) { len += len > 0 ? this.options.navspacing : 0;
                            len += this.options.navheight } } $bulletWrapper.css({ height: len + "px", width: "auto" })
                    ...
                    if (this.options.navshowbuttons) { if (this.options.navshowarrow) { len += len > 0 ? this.options.navspacing : 0;
                            len += 2 * this.options.navwidth + this.options.navspacing } if (this.options.navshowplaypause && !this.options.navshowplaypausestandalone) { len += len > 0 ? this.options.navspacing : 0;
                            len += this.options.navwidth } } $bulletWrapper.css({ width: len + "px", height: "auto" })
                }
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        if (instance.options.navthumbnavigationstyle == "arrow") {
                            ...
                            if (instance.options.navdirection == "horizontal")
                                ...
                                } else { var n = Math.floor(($nav.width() - 2 * m + instance.options.navspacing) / (instance.options.navwidth + instance.options.navspacing)); if (n <= 0) n = 1;
                                    m = Math.floor(($nav.width() - n * instance.options.navwidth - (n - 1) * instance.options.navspacing) / 2);
                                    $navContainer.css({ "margin-left": m + "px", "margin-right": m + "px" }) }
                            else $navContainer.css({ "margin-top": m + "px", "margin-bottom": m + "px" })
                    ...
                    if (instance.options.navdirection == "vertical") $nav.touchSwipe({ preventWebBrowser: true, swipeTop: function(data) { instance.carMoveTop() }, swipeBottom: function() { instance.carMoveBottom() } });
                    else $nav.touchSwipe({ preventWebBrowser: false, swipeLeft: function(data) { instance.carMoveLeft() }, swipeRight: function() { instance.carMoveRight() } });
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        if (this.options.navshowplayvideo) { var $previewPlay = $("<div class='amazingslider-nav-preview-play-" + this.id + "' style='display:none;position:absolute;left:0;top:0;width:100%;height:100%;" + 'background:url("' + this.options.skinsfolder + this.options.navplayvideoimage + '") no-repeat center center;' + "' ></div>");
                            $preview.append($previewPlay) } $(".amazingslider-wrapper-" + this.id, this.container).append($preview)
                    }
            ...
            createNavBullet: function(index) {
                ...
                if (this.options.navstyle == "bullets") { $bullet.css({ background: "url('" + this.options.navimage + "') no-repeat left top" });
                    $.fn["bulletNormal" + this.id] = function() { $(this).css({ "background-position": "left top" }) };
                    $.fn["bulletHighlight" + this.id] = $.fn["bulletSelected" + this.id] = function() { $(this).css({ "background-position": "left bottom" }) } } else if (this.options.navstyle == "numbering") {
                    $bullet.text(index + 1);
                    $bullet.css({
                    ...
                    $.fn["bulletSelected" + this.id] = function() {
                        ...
                        if (instance.options.navdirection == "horizontal") {
                            ...
                            if (instance.options.navshowfeaturedarrow) { var $featuredarrow = $(".amazingslider-nav-featuredarrow-" + instance.id, instance.container);
                                $featuredarrow.css({ top: t + "px" }); if ($featuredarrow.is(":visible")) $featuredarrow.stop(true, true).animate({ left: l + "px" });
                            ...
                            if ($navContainer.width() < $bulletWrapper.width() && !instance.pauseCarousel) {
                                ...
                                if (pos.left < m || pos.left + instance.options.navwidth > m + $navContainer.width()) { var pl = -pos.left; if (pl <= $navContainer.width() - $bulletWrapper.width()) pl = $navContainer.width() - $bulletWrapper.width(); if (pl >= 0) pl = 0;
                            ...
                            if (instance.options.navshowfeaturedarrow) { var $featuredarrow = $(".amazingslider-nav-featuredarrow-" + instance.id, instance.container);
                                $featuredarrow.css({ left: l + "px" }); if ($featuredarrow.is(":visible")) $featuredarrow.stop(true, true).animate({ top: t + "px" });
                            ...
                            if ($navContainer.height() < $bulletWrapper.height() && !instance.pauseCarousel) {
                                ...
                                if (pos.top < m || pos.top + instance.options.navheight > m + $navContainer.height()) { var pl = -pos.top; if (pl <= $navContainer.height() - $bulletWrapper.height()) pl = $navContainer.height() - $bulletWrapper.height(); if (pl >= 0) pl = 0;
                        ...
                        $swipeBox.unbind("click").bind("click",
                            function() {
                                if (instance.elemArray[instance.curElem][ELEM_LIGHTBOX]) { $(window).trigger("amazingslider.lightboxclicked", [instance.options.sliderid, instance.elemArray[instance.curElem][ELEM_ID], instance.elemArray[instance.curElem][ELEM_SRC], instance.elemArray[instance.curElem][ELEM_TITLE], instance.elemArray[instance.curElem][ELEM_LINK]]); if (!instance.isPaused) { instance.lightboxPaused = true;
                                        ...
                                        instance.sliderTimeout.pause() } instance.html5Lightbox.showItem(instance.elemArray[instance.curElem][ELEM_LINK]) } else {
        ...
        for (var key in options)
            if (key.toLowerCase() !== key) { options[key.toLowerCase()] = options[key];
                delete options[key] } this.each(function() {
            ...
            for (var i = 0; i < searchstring.length; i++) { var keyvalue = searchstring[i].split("="); if (keyvalue && keyvalue.length == 2) { var key = keyvalue[0].toLowerCase(); var value = unescape(keyvalue[1]).toLowerCase(); if (value == "true") searchoptions[key] = true;
                    ...
                    else searchoptions[key] = value } } this.options = $.extend(this.options, searchoptions);
            var defaultOptions = {
                ...
                wtextcssdefault: "font:12px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:none;opacity:0.9;filter:alpha(opacity=90);",
...
(function($) { $.ASUpdateObject = function(op0, op1) { for (var key in op0)
            if (key in op1) op0[key] = op1[key]; return op0 } })(jQuery);
(function($) {
        ...
        if (ASPlatforms.isIE6789()) {
            ...
            if (effect == "zoomout") {
                ...
                (function asDrawKenBurnsZoomOut() {
                    ...
                    switch (direction) {
                        case 0:
                            context.drawImage(image, 0, 0, w, h, w - scale * w, h - scale * h, scale * w, scale * h); break;
                        case 1:
                            context.drawImage(image, 0, 0, w, h, 0, h - scale * h, scale * w, scale * h); break;
                        case 2:
                            context.drawImage(image, 0, 0, w, h, w - scale * w, 0, scale * w, scale * h); break;
                        default:
    ...
    $.fn.sliceTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            if (Math.abs(options.imgmarginleft) > 0) { $img.css({ "margin-left": options.slicecount * options.imgmarginleft + "%" });
                ...
                $img.css({ "max-width": options.slicecount * 100 + "%", left: "-" + sliceW * i + "px", width: options.slicecount * 100 + "%" }) } $imgSlice.append($img);
        ...
        slices.each(function() {
            ...
            switch (effect) {
                ...
                case "updown":
                    ...
                    else slice.css({ top: "", bottom: "0%", height: "0%" }); break } setTimeout(function() { slice.animate({ height: "100%" }, duration, options.easing) }, interval * index);
            index++
        });
    ...
    $.fn.threedTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        $prev.hide();
        if (scaleDuration > 0) { cubes.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": scaleDuration + "ms" }));
            setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transform": "scale(" + options.scale + ") translateZ(-" + dist + "px" + ")" })) }, scalePrepare) } index = 0;
        cubes.each(function() {
            var cube =
                $(this);
        ...
        if (scaleDuration > 0) setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transition-duration": scaleDuration + "ms", "transform": "scale(1) translateZ(-" + dist + "px" + ") rotateX(" + (options.direction ? "-89.99" : "89.99") + "deg)" })) },
    ...
    $.fn.threedHorizontalTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        $parent.unbind("transitionFinished").bind("transitionFinished",
            function() { $parent.unbind("transitionFinished");
                $prev.remove();
                $next.show();
                setTimeout(function() { $cubeWrapper.remove() }, 100);
                callback() });
        ...
        for (i = 0; i < options.rowcount; i++)
            for (j = 0; j < options.columncount; j++) {
                ...
                if (Math.abs(options.imgmarginleft) > 0) {
                    ...
                    $img.css({ "max-width": options.columncount * 100 + "%", left: "-" + blockW * j + "px", top: "-" + blockH * i + "px", width: options.columncount * 100 + "%" }) } $imgBlock.append($img);
        ...
        return this.each(function() {
            ...
            function touchMove(event) {
                ...
                if (e.targetTouches.length >= 1) { curX = e.targetTouches[0].pageX;
                    curY = e.targetTouches[0].pageY } else touchReset()
            }

            function touchEnd(event) { if (curX > 0 || curY > 0) { triggerHandler();
                    touchReset() } else touchReset() }

            function touchCancel(event) { if (navigator.userAgent.match(/Android/i) != null) triggerHandler();
                touchReset() }

            function touchReset() { startX = -1;
                startY = -1;
                curX = -1;
                curY = -1 }
...
jQuery(document).ready(function() {
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        textbgcss: "display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:none opacity:0.6; filter:alpha(opacity=60);",
        ...
        //transition:"fade",
        transition: "slide",
        transition: "tiles,blocks,flip,flipwithzoom,blinds",
